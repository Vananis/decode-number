    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <article className="prose prose-gray max-w-none">
          <div
            className="text-gray-700 leading-relaxed [&_h1]:text-3xl [&_h1]:md:text-4xl [&_h1]:font-bold [&_h1]:text-indigo-900 [&_h1]:mb-8 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-indigo-800 [&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:pb-2 [&_h2]:border-b [&_h2]:border-indigo-100 [&_h3]:text-xl [&_h3]:font-medium [&_h3]:text-indigo-700 [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_li]:mb-2 [&_a]:text-indigo-600 [&_a]:hover:text-indigo-800 [&_table]:w-full [&_table]:my-6 [&_table]:border [&_table]:border-gray-300 [&_th]:bg-indigo-100 [&_th]:p-3 [&_th]:text-left [&_th]:text-indigo-800 [&_th]:border [&_th]:border-gray-300 [&_td]:p-3 [&_td]:border [&_td]:border-gray-300 [&_blockquote]:border-l-4 [&_blockquote]:border-indigo-400 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-gray-600 [&_blockquote]:bg-indigo-50 [&_blockquote]:py-2 [&_strong]:text-gray-900"
